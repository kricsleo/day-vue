import { StorageSerializers, useLocalStorage, RemovableRef, useMousePressed } from '@vueuse/core'
...
export const menuPlanId = ref(null as number | null)
export const menuRowPlanId = ref(null as string | null)
export const activePlanId = computed(() => editingPlanId.value || highlightPlanId.value || menuPlanId.value)
